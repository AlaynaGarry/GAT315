...
public class Collision
{
    ...
    public static void ApplyImpulses(List<Contact> contacts) {
        foreach (var contact in contacts) {
            Vector2 realitiveVelocity = contact.bodyA.velocity - contact.bodyB.velocity;
            float normalVelocity = Vector2.Dot(realitiveVelocity, contact.normal);
